			...
			<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
				<header class="entry-header">
					...
					<nav id="image-navigation" class="site-navigation">
						<span class="previous-image"><?php previous_image_link( false, __( '&larr; anterior', 'vantage' ) ); ?></span>
						<span class="next-image"><?php next_image_link( false, __( 'Siguiente &rarr;', 'vantage' ) ); ?></span>
