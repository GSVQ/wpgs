	...
	<div class="entry-main">
		...
		<?php else : ?>
			<div class="entry-content">
				<?php if(siteorigin_setting('blog_archive_content') == 'excerpt') the_excerpt(); else the_content( __( 'Sigue leyendo <span class="meta-nav">&rarr;</span>', 'vantage' ) ); ?>
				<?php wp_link_pages( array( 'before' => '<div class="page-links">' . __( 'Páginas:', 'vantage' ), 'after' => '</div>' ) ); ?>
			</div><!-- .entry-content -->
		<?php endif; ?>
